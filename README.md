...
Six registries are live: **Verra VCS**, **Gold Standard**, **Cercarbono**,
**Plan Vivo**, **SocialCarbon** and **BioCarbon** — 9,773 projects. They share
one database and one spreadsheet; the `Registry` column tells the rows apart.
...
| File | What it is |
|---|---|
| `data/verra.db` | SQLite database. The source of truth: ~5,200 Verra projects plus the full Units ledger, 4,141 Gold Standard projects plus 182,989 credit blocks, 231 Cercarbono projects, 105 BioCarbon, 32 Plan Vivo and 19 SocialCarbon. |
